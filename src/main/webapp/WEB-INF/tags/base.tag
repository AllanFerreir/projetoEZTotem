        ...
        <nav id="js-sidebar" class="col-md-2 d-none d-md-block bg-light sidebar" data-navbar="<jsp:invoke fragment="navbar"/>">
            <div class="sidebar-sticky" style="font-size: 40px !important; text-align: center !important; background-color: #272c30 !important; list-style: none;
                <ul style="list-style: none;" class="nav flex-column" >
                    <li class="nav-item">
                        <a class="nav-link js-lanches" style="color: #fff; padding-top: 100px" href="<c:url value="/produtos?categoria=lanche"/>">Lanches</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-bebidas" style="color: #fff; padding-top: 100px" href="<c:url value="/produtos?categoria=bebida"/>">Bebidas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-sobremesas" style="color: #fff; padding-top: 100px" href="<c:url value="/produtos?categoria=sobremesa"/>">Sobremesas</a>
                    </li>
                </ul>
            </div>
        </nav>
